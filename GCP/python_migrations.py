...
class MedicalRecord(Base):
    ...
    # Ensure that the indentation is correct for the relationship line
...
connection_string = (f'mysql+mysqlconnector://{DB_USERNAME}:{DB_PASSWORD}@{DB_HOST}:{DB_PORT}/{DB_DATABASE}'
